...
export const SYSTEMS: SystemInfo[] = [
  ...
  },
  {
    ...
    isNew: true,
    summary:
      'A seven-island archipelago in the Twin Seas, the largest area added since launch, with the hub city Temis (Queen Andreona / The Oracle). 8 waypoints, 12 dungeons, 3 strongholds, 30 side quests.',
