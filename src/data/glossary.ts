...
export const GLOSSARY: GlossaryTerm[] = [
  ...
  },
  {
    ...
    seeAlso: ["Whispers / Tree of Whispers", "War Plans", "Torment", "Experience Well"],
  },
  {
    term: "Experience Well",
    category: "Progression",
    short: "Open-world XP wells (Forgotten Wisdom) that grant +15% experience for 1 hour.",
    full: "Experience Wells appear in the open world (especially during Helltides). Activating one applies the Forgotten Wisdom buff for +15% XP/hour. Prioritize them while leveling 45–60 for a noticeable speed boost on top of difficulty-scaled gains.",
    seeAlso: ["Helltide", "Tree of Whispers"],
  },
  {
    ...
    seeAlso: ["The Pit", "Helltide", "Torment", "Sigil"],
  },
  {
    term: "Sigil",
    category: "Endgame",
    short: "Consumable that opens an affixed Nightmare Dungeon.",
    full: "Nightmare Sigils (often just called Sigils) are the key to Nightmare Dungeons. They add modifiers, increase monster density, and enable Cursed Chest/Shrine events that are excellent for XP. Sigils drop after the campaign and are a core 50–70 activity.",
    seeAlso: ["Nightmare Dungeon", "Capstone Dungeon"],
  },
  {
  ...
  },
  {
    ...
    seeAlso: ["Resolve", "Specialization", "Book of the Dead", "Arbiter Form"],
  },
  {
    term: "Arbiter Form",
    category: "Classes",
    short: "Paladin's temporary angelic ascended state granting major damage.",
    full: "Granted by the Disciple Oath (one of four Oaths chosen at 15). Casting Disciple cooldown skills (Condemn, Falling Star, etc.) puts you into Arbiter Form for ~4.5s with ~50% increased damage and a radiant winged visual. Maintaining uptime via CDR and cooldown chaining is the core of Disciple builds.",
    seeAlso: ["Oath"],
  },
  {
    term: "Soul Shard",
    ...
    seeAlso: ["Enchantment", "Oath", "Specialization", "Fragment Bonus", "Demonform"],
  },
  {
    term: "Fragment Bonus",
    category: "Classes",
    short: "Warlock power spike at level 30 that upgrades your chosen Soul Shard.",
    full: "At level 30 Warlocks unlock a Fragment Bonus for their Soul Shard (different per shard: Sacrificial for Legion, Blasphemous for Mastermind, Evisceration for others). These grant powerful upgrades such as Unstoppable or improved minion/demon scaling. Slot the quest reward immediately.",
    seeAlso: ["Soul Shard"],
  },
  {
    term: "Demonform",
    category: "Classes",
    short: "Warlock Vanguard Soul Shard transform into a hulking demon.",
    full: "The Vanguard Soul Shard lets a Warlock temporarily become a Greater Demon (Abodian). It is a high-mobility, high-damage melee form that complements the dual Wrath/Dominance resource loop. Strong for players who enjoy aggressive shapeshifting play.",
    seeAlso: ["Soul Shard"],
  },
  {
    term: "Enchantment",
